# -*- coding: utf-8 -*-
#
# vmo_i-score_generator documentation build configuration file, created by
# sphinx-quickstart on Tue Apr 12 18:17:04 2016.
#
...
# html_title = u'vmo_i-score_generator v'
...
htmlhelp_basename = 'vmo_i-score_generatordoc'
...
latex_documents = [(
        master_doc,                    # only one tex file
        'vmo_score.tex',               # output .tex file
        u'VMO-Score Documentation',    # document title
        u'''Jaime Arias,\\\\
        Myriam Desainte-Catherine,\\\\
        and Shlomo Dubnov''',          # document's author
...
# Prevent import errors to halt the building process when some external
...
# Include special members (like __membername__) with docstrings in the
# documentation
